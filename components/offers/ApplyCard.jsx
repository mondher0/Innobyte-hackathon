...
const ApplyCard = ({ rating }) => {
  return (
    <div className="flex  min-h-full   flex-col items-start justify-start max-w-[300px] w-full gap-4 border-solid border-#6B7280 border-2  p-5 rounded-sm border-l-transparent  ">
